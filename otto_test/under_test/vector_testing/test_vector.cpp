...
}
{
  ...
  std::cout << "Vector is empty ? : " << s1.empty() << std::endl;
  std::cout << "Vector size ? : " << s1.size() << std::endl;
  // std::cout << "Testing pop_back call on empty vector - causes
  // undefined
  //         // behaviour" << std::endl; s1.pop_back(); std::cout << "Vector
  //         size after
  //             // pop ? : " << s1.size() << std::endl;

  std::cout << "Testing get_allocator call on empty vector" << std::endl;
  std::cout << "Size of allocator ? : " << sizeof(s1.get_allocator())
            << std::endl;
  // s3 = s1;
  ...
  }
  {
    ...
    std::cout << "Iterator comparison < result : " << (it2 < it1) << std::endl;
    std::cout << "Iterator comparison <= result : " << (it2 <= it1)
              << std::endl;
    std::cout << "Iterator comparison >= result: " << (it2 >= it1) << std::endl;
    std::cout << " Iterator comparison == result : " << (it2 == it1)
              << std::endl;
  ...
  }
  {
    ...
    v1.push_back(10);
    it1 = v1.begin();
    NAMESPACE::vector<int>::const_iterator ite12 = v1.end();
    std::cout << "Value at beginning of vector: " << *it1 << std::endl;
    while (it1 != ite12) {
      std::cout << "Value at vector "
                << ": " << *it1 << std::endl;
  ...
  {
    std::cout << "Testing const iterator operation and comparisons"
              << std::endl;
    NAMESPACE::vector<int> v1;
    NAMESPACE::vector<int>::const_iterator it1;
    v1.push_back(42);
  ...
  {
    std::cout << "Testing iterator operation and comparisons for strings"
              << std::endl;
    NAMESPACE::vector<std::string> v1;
    NAMESPACE::vector<std::string>::iterator it1;
    v1.push_back("banana");
  ...
  {
    std::cout
        << "Testing simple reverse_iterator ctor and operator and comparison "
        << std::endl;
    NAMESPACE::vector<int> v1;
    v1.push_back(42);
    v1.push_back(21);
    ...
    rit1 = v1.rbegin();
    while (rit1 != v1.rend()) {
      std::cout << "Reversed iteration through vector yield: " << *rit1
                << std::endl;
      rit1++;
    }
  ...
  {
    std::cout << "Testing reverse_iterator comparisons and additional non - "
                 "member operators"
              << std::endl;
    NAMESPACE::vector<int> v1;
    NAMESPACE::vector<int>::iterator it1;
    ...
    std::cout << "Reverse iterator comparison > result : " << (rit2 > rit1)
              << std::endl;
    std::cout << "Reverse iterator comparison < result : " << (rit2 < rit1)
              << std::endl;
    std::cout << "Reverse iterator comparison <= result : " << (rit2 <= rit1)
  ...
  {
    std::cout << "Testing const_reverse_iterator comparisons and additional "
  ...
  }
  {
    ...
    //   std::cerr << v42.max_size() << std::endl;
  ...
  }
  {
    ...
    std::size_t sz = 42;
    // ! Erreur de compilation si le type n'est pas précisé pour la size
    // ->pb
    // overload avec le range ctor
  ...
  }
  {
    ...
    std::cout << "Value inserted : " << *(v1.insert(it2, "banana"))
              << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity :" << v1.capacity()
              << std::endl;
  ...
  }
  {
    ...
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    std::cout << "Iterator following last removed el: " << *(v1.erase(it1))
              << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    ...
    it1 = v1.end() - 1;
    std::cout << "Iterator following last removed el is v1.end(): "
              << (v1.erase(it1) == v1.end()) << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    while (it1 != v1.end()) {
  ...
  }
  {
    ...
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    std::cout << "Iterator following last removed el: "
              << *(v1.erase(it1, it1 + 1)) << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    while (it1 != v1.end()) {
    ...
    it1 = v1.begin() + 7;
    std::cout << "Iterator following last removed eEEEEEEEEEEEEEl: "
              << *(v1.erase(it1, v1.end())) << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    ...
    it1 = v1.end();
    std::cout << "Iterator following last removed el is v1.end(): "
              << (v1.erase(it1 - 4, it1) == v1.end()) << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    while (it1 != v1.end()) {
    ...
    it1 = v1.end();
    std::cout << "Iterator following last removed el is v1.end(): "
              << (v1.erase(it1, it1) == v1.end()) << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
    while (it1 != v1.end()) {
    ...
    it1 = v1.begin();
    std::cout << "Iterator following last removed el: " << *(v1.erase(it1, it1))
              << std::endl;
    std::cout << "Size : " << v1.size() << " -- Capacity : " << v1.capacity()
              << std::endl;
    it1 = v1.begin();
  ...
  {
    std::cout << "Testing erase a range of values from std::string vector "
              << std::endl;
    NAMESPACE::vector<std::string> v1;
    std::size_t i = 0;
  ...
  }
  {
    ...
    std::cout << "s6 <= s3: " << (s6 != s3) << std::endl;
    std::cout << "s6 >= s3: " << (s6 != s3) << std::endl;
    std::cout << "TESTING OPERATORS one vector is a subset of the other"
              << std::endl;
